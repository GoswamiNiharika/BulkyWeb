...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            {
                ShoppingCartViewModel.OrderHeader.PaymentStatus = OrderStatus.PaymentStatusPending;
                ShoppingCartViewModel.OrderHeader.OrderStatus = OrderStatus.StatusPending;
            }
            else
            {
                ShoppingCartViewModel.OrderHeader.PaymentStatus = OrderStatus.PaymentStatusDelayedPayment;
                ShoppingCartViewModel.OrderHeader.OrderStatus = OrderStatus.StatusApproved;
            }
